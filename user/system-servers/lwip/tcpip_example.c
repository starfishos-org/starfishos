...
int main(int argc, char **argv)
{
	...
	int server_cap = create_thread(server_routine, 0, 255, 0);
	int client_cap = create_thread(client_routine, 0, 255, 0);
	printf("[LWIP] server_cap: %d\n", server_cap);
	printf("[LWIP] client_cap: %d\n", client_cap);
