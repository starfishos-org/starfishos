...
_Noreturn void __pthread_exit(void *result)
{
	...
	if (state==DT_DETACHED && self->map_base) {
		...
		/* WARN: Following function will directly use syscalls */
...
int chcore_pthread_create(pthread_t *restrict res,
			  const pthread_attr_t *restrict attrp,
			  void *(*entry)(void *),
			  void *restrict arg)
{
 ...
 */
int chcore_pthread_create_shadow(pthread_t *restrict res,
				 const pthread_attr_t *restrict attrp,
				 void *(*entry)(void *),
				 void *restrict arg)
{
...
int chcore_pthread_create_register_cb(pthread_t *restrict res,
				 const pthread_attr_t *restrict attrp,
				 void *(*entry)(void *),
				 void *restrict arg)
{
