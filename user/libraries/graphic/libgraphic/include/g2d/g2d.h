 ...
 * @return 0 if succ.
 */
int draw_arc(const PDC dc, int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4);
/**
 * Draw an ellipse.
 * @param dc Pointer to the device context where drawing takes place.
 ...
 * @param right The x-coordinate, in pixels, of the right bounder of the ellipse.
 * @param bottom The y-coordinate, in pixels, of the bottom bounder of the ellipse.
 * @return 0 if succ.
 */
 ...
 * @param x1 The x-coordinate, in pixels, of the upper-left corner of the destination rect.
 * @param y1 The y-coordinate, in pixels, of the upper-left corner of the destination rect.
 ...
 * @param x2 The x-coordinate, in pixels, of the upper-left corner of the source rect.
 * @param y2 The y-coordinate, in pixels, of the upper-left corner of the source rect.
 * @param rop The raster-operation code, which defines how the color data of the source rect
 * is to be combined with the color data of the destination rect to achieve the final color.
 * @return 0 if succ.
 */
int bitblt(const PDC dst, int x1, int y1, int width, int height,
 ...
 * @return 0 if succ.
 */
int stretch_blt(const PDC dst, int x1, int y1, int w1, int h1,
	const PDC src, int x2, int y2, int w2, int h2, enum ROP rop);
/**
...
int stretch_bitmap(const PDC dst, int x1, int y1, int w1, int h1,
	const PBITMAP bitmap, int x2, int y2, int w2, int h2, enum ROP rop);
...
int blend(const PDC dst, int x1, int y1, int w1, int h1,
	const PDC src, int x2, int y2, int w2, int h2, u8 alpha);
int blend_rgba(const PDC dst, int x1, int y1, int w1, int h1,
	const PDC src, int x2, int y2, int w2, int h2, u8 alpha);
...
/**
 * Get the color index in palette of the pixel (x, y) of the device-independent bitmap.
 * @param dib Pointer to the device-independent bitmap.
 * @param x The x-coordinate, in pixels, of the pixel.
 * @param y The y-coordinate, in pixels, of the pixel.
...
/**
 * Set the color index in palette of the pixel (x, y) of the device-independent bitmap.
 * @param dib Pointer to the device-independent bitmap.
 * @param x The x-coordinate, in pixels, of the pixel.
 * @param y The y-coordinate, in pixels, of the pixel.
