...
void blend_pixel_16(RGB565 *dst, const RGB565 *src, u8 alpha)
{
	...
	g /= 255;
	r = get_rgb565_red(*dst) * (255 - alpha) +
		get_rgb565_red(*src) * alpha;
	r /= 255;
...
int _blend(const PDC dst, int x1, int y1, int w1, int h1,
...
int _blend_rgba(const PDC dst, int x1, int y1, int w1, int h1,
	const PDC src, int x2, int y2, int w2, int h2, u8 alpha)
{
