...
enum DIB_STATUS
{
	...
	DIB_OUT_OF_MEMORY,		/* Could not allocate enough memory to complete the operation */
	...
	DIB_TYPE_MISMATCH,		/* The requested action is not compatible with the DIB's type */
	DIB_ERR_MAX
};
...
/* Error handling */
enum DIB_STATUS _dib_get_error();
const char *_dib_get_error_desc();
