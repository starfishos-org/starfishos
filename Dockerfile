...
RUN test -f /chos/user/demos/YCSB-C/redis/hiredis/Makefile || \
    (echo "YCSB-C submodule is missing; run git submodule update --init --recursive before docker build" >&2 && false)
