/*
 * refer: https://github.com/henning-schild-work/ivshmem-guest-code/kernel_module/standard/kvm_ivshmem.c
 */
...
static void ivshmem_setup_dev(struct pci_dev *pdev)
{
...
void ivshmem_setup_devices()
{
        ...
        pci_buses_traverse_all(ivshmem_setup_dev);
}
