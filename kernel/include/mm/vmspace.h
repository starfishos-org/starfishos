...
#define VM_FLAG_PRESERVE 1 /* pages in the vmspace are referenced by some checkpoints */
...
struct vmspace {
	...
	void *pte_patch_pool;
	// struct lock pte_patch_lock;

	// void *pre_memcpy_pte_patch_pool;
	// struct lock pre_memcpy_pte_patch_lock;
