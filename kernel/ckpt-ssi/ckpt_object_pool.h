...
struct ckpt_object *get_latest_ckpt_obj(struct ckpt_obj_root *ckpt_obj_root,
                                        u64 version_number);
...
void set_latest_ckpt_obj(struct ckpt_obj_root *ckpt_obj_root,
                         u64 version_number, struct ckpt_object *ckpt_obj);

void set_second_latest_ckpt_obj(struct ckpt_obj_root *ckpt_obj_root,
                                u64 version_number,
