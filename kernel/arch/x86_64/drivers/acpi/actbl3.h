...
#define ACPI_SRAT_MEM_HOT_PLUGGABLE \
    (1 << 1) /* 01: Memory region is hot pluggable */
#define ACPI_SRAT_MEM_NON_VOLATILE \
    (1 << 2) /* 02: Memory region is non-volatile */
