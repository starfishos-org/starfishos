...
# tmux send -t $session_name:$window_name.$window_start_index "./build/simulate.sh 0
# sleep 5
# tmux send -t $session_name:$window_name.$((window_start_index + 1)) "./build/simulate.sh 1
