...
tmux send -t mywork:window0.1 "./build/simulate.sh > exec_log | tee exec_log1" ENTER
sleep 3
tmux send -t mywork:window0.2 "./build/simulate.sh > exec_log | tee exec_log2" ENTER
