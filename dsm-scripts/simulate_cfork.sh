...
tmux send -t $session_name:$window_name.$window_start_index "./dsm-scripts/tests/cfork_prepare.exp $program" ENTER &
sleep 5
tmux send -t $session_name:$window_name.$((window_start_index + 1)) "./dsm-scripts/tests/cfork_restore.exp $program" ENTER &
